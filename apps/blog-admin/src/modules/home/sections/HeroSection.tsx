export function HeroSection() {
  return (
    <section
      className="relative h-dvh md:h-screen min-h-[700px] bg-zinc-900 text-white flex flex-col items-center justify-start md:justify-center overflow-hidden"
    ...
    <div class="relative z-20 flex flex-col items-center text-center px-6 mt-12 md:mt-44">
      ...
      <div class="flex items-center gap-2 sm:gap-6 mt-6 sm:mt-8 md:mt-12 text-white">
        <a href="https://wa.me/5548991587232" target="_blank" rel="noopener noreferrer"
          aria-label="Entre em contato pelo WhatsApp"
          class="text-white border border-transparent hover:border-blue-700 transition-colors duration-300 p-4 rounded-lg bg-transparent ">
          <svg class="w-6 h-6 md:w-8 md:h-8" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <a href="https://www.instagram.com/eduardopavanipro" target="_blank" rel="noopener noreferrer"
          ...
          class="text-white border border-transparent hover:border-blue-700 transition-colors duration-300 p-4 rounded-lg bg-transparent ">
          <svg class="w-6 h-6 md:w-8 md:h-8" viewBox="0 0 1000 1000" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
