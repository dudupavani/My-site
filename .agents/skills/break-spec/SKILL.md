...
name: break-spec
description: |
  Use quando existir uma spec macro já criada e for necessário quebrá-la em etapas menores de execução (micro-specs) mantendo o contexto global.
...
A spec deve estar localizada em: plans/<nome-da-spec>/
