...
export function ProductThinkingSection() {
  return (
    <section className="bg-blue-700 text-white">
      <div className="max-w-6xl mx-auto text-left md:text-center py-16 sm:py-20 lg:py-32 sm:pb-16 px-6">
        ...
        <p className=" text-xl sm:text-2xl mx-auto font-light leading-[1.7]!">
