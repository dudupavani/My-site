...
export function BaseSection() {
  return (
    <section className="bg-stone-100 pt-16 pb-24 md:py-24 px-6 md:px-24">
      <div className="flex flex-col max-w-7xl mx-auto">
        <div className="mb-10 md:mb-8 max-w-4xl">
          <h2 className="text-3xl md:text-4xl lg:text-4xl text-stone-800 font-semibold mb-4 sm:mb-2 -tracking-[0.02em] leading-[1.4]">
            Base que sustenta minha atuação
          </h2>
          <p className="text-base md:text-xl text-stone-500 text-regular md:text-light leading-[1.7]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-7xl">
          <div className="space-y-6 md:space-y-10 text-sm sm:text-base leading-[1.8] text-stone-900 text-regular md:text-light">
          ...
          <div className="relative flex items-center justify-center min-h-[400px] rounded-md overflow-hidden p-4 sm:p-8 md:p-12">
            ...
            <h3 className="relative z-10 text-xl md:text-2xl font-regular md:font-light lg:font-extralight text-white leading-normal lg:text-right">
