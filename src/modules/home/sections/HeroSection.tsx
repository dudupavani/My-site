export function HeroSection() {
  return (
    <section className="relative h-dvh md:h-screen min-h-175 bg-stone-950 text-white flex flex-col items-center justify-start md:justify-center overflow-hidden">
      ...
      <div className="absolute z-5 top-62.5 -left-55 sm:top-42.5 sm:-left-32.5">
        <svg
          viewBox="0 0 150 150"
          xmlns="http://www.w3.org/2000/svg"
          className="w-37.5 h-37.5 origin-top-left scale-[4] sm:scale-[8] opacity-50 fill-current text-[#998663]"
          aria-hidden="true">
          <path
      ...
      {/* Simbolo blur light */}
      <div className="absolute inset-0 opacity-50 z-20 top-100 2xl:top-130 left-40 2xl:left-80 scale-100  object-contain mix-blend-multiply! blur-3xl">
        <svg
          viewBox="0 0 150 150"
          xmlns="http://www.w3.org/2000/svg"
