    ...
    <section className="relative h-dvh md:h-screen min-h-[700px] bg-zinc-900 text-white flex flex-col items-center justify-start md:justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 flex items-end justify-center">
        ...
        <img
          ...
          alt="Eduardo Pavani"
          className="max-w-[115%] max-h-[80%] sm:h-full sm:max-h-full sm:max-w-lg md:max-w-xl lg:max-w-[100%] w-auto object-contain object-bottom"
        />
      </div>

      <div className="relative z-20 flex flex-col items-center text-center px-6 mt-12 md:mt-44">
        <div className="flex items-center mb-6 md:mb-6">
          <img src="/images/logo.svg" alt="eduardopavani" className="h-11 sm:h-14 md:h-20 lg:h-28 w-auto" />
        </div>
        <h1 className="text-lg sm:text-xl md:text-2xl md:text-4xl max-w-3xl !leading-relaxed font-extralight">
