  ...
  return (
    <section className="relative bg-stone-900 text-white py-20 sm:py-24 md:py-32 px-4 sm:px-12 md:px-20 lg:px-24 overflow-hidden">
      <div className="flex items-center gap-24">
        <div className="flex flex-col gap-4 xl:gap-8 items-center basis-0 grow-6">
          <div className="space-y-4 max-w-4xl text-left px-4 sm:px-0">
            ...
            <p className="text-stone-300 text-lg md:text-xl leading-[1.6] font-regular lg:font-extralight">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="flex items-start gap-2 md:gap-4 border-b border-stone-700/40 py-6">
        ...
        <div className="basis-0 grow-4">
          <img
            src="/images/me-final.webp"
            alt="eduardo pavani - product lead"
            className="w-full h-auto rounded-3xl shadow-2xl shadow-stone-950/40"
          />
        </div>
      </div>
    </section>
